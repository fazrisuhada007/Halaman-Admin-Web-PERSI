              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="<?php base_url('admin/pelayanan_penunjang/tambah')?>" method="POST">

                       <div class="form-group">
                        <label>Nama pelayanan Penunjang</label>
                        <input type="text" name="nama_pelayanan_penunjang" placeholder="Nama Pelayanan Penunjang" value="<?php echo set_value('nama_pelayanan_penunjang')?>" class="form-control col-md-5" autocomplete="off" autofocus />
                      </div>
