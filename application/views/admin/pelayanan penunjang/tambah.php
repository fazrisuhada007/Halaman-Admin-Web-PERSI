                  ...
                  <div class="card-body">
                    ...
                    <form action="<?php base_url('admin/pelayanan_penunjang/tambah')?>" method="POST">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" name="nama_pelayanan_penunjang" class="form-control col-md-5" placeholder="Nama Pelayanan Penunjang" value="<?php echo set_value('nama_pelayanan_penunjang')?>">
                      </div>
