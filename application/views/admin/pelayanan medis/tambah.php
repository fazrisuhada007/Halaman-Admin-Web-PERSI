              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="<?php base_url('admin/pelayanan_medis/tambah')?>" method="POST">
                      <div class="form-group">
                        <label>Nama Pelayanan Medis</label>
                        <input type="text" name="nama_pelayanan_medis" placeholder="Nama Pelayanan Medis" value="<?php echo set_value('nama_pelayanan_medis')?>" class="form-control col-md-5" autocomplete="off" autofocus />
                      </div>
