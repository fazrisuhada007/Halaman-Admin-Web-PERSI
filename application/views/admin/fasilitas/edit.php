                  ...
                  <div class="card-body">
                    ...
                    <form action="<?php base_url('admin/fasilitas/edit'.$fasilitas->id_fasilitas)?>" method="POST">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_fasilitas" placeholder="Nama Fasilitas" value="<?php echo $fasilitas->nama_fasilitas?>" class="form-control col-md-5" autocomplete="off" autofocus />
                      </div>
